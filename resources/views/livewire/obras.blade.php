        ...
        <table class="min-w-full divide-y divide-slate-200">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-gray-600">Valor total</th>
                    <th scope="col" class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-gray-600">Total recebido</th>
                    <th scope="col" class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-gray-600">Total a receber</th>
            ...
            <div class="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-2xl">
                ...
                <form wire:submit.prevent="updateValores" class="mt-4 space-y-4">
                    <div class="rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-700">
                        ...
                        <p><span class="font-semibold text-gray-900">Valor pendente:</span> R$ {{ number_format($obraBeingEdited->valor_pendente_display ?? 0, 2, ',', '.') }}</p>
                    </div>
